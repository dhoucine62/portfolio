<template>
  <nav class="bg-slate-900/80 backdrop-blur-md border-b border-slate-800 w-full sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
        <div class="flex-shrink-0 flex items-center">
          <span class="font-extrabold text-3xl tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-fuchsia-500">
            Houcine.
          </span>
        </div>
        ...
        <div class="hidden md:flex items-center">
          <a href="https://github.com/dhoucine62" target="_blank" rel="noopener noreferrer" class="group relative px-6 py-2.5 font-semibold text-white rounded-full bg-slate-800 border border-slate-700 hover:border-cyan-500 hover:shadow-[0_0_15px_rgba(34,211,238,0.3)] transition-all duration-300 flex items-center gap-2">
